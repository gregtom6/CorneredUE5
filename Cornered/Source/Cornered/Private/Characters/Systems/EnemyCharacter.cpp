...
AEnemyCharacter::AEnemyCharacter()
{
	...
	FallenParticlesNiagara = CreateDefaultSubobject<UNiagaraComponent>(TEXT("FallenParticlesNiagara"));
	...
	FallenParticlesNiagara->AttachToComponent(SceneComponent, FAttachmentTransformRules::KeepRelativeTransform);
